(function() {
    ...
    ScheduleTemplate.prototype.loadEventContent = function(target) {
        ...
        var data = {
            ...
            estimation: target.getAttribute('data-estimation'),
            effort: target.getAttribute('data-effort'),
            card: target.getAttribute('data-card'),
            edit: target.getAttribute('data-edit'),
        }
        ...
        html +=  `<ul>` +
            `<li><strong>Estimation :</strong> ${ data.estimation }h </li>` +
            `<li><strong>Effort :</strong> ${ data.effort } </li>` +
            `<li><strong>Carte :</strong> <a href="${data.card}" target="_blank">Ouvrir</a>  </li>` +
            `<li><strong>Modifier :</strong> <a href="${data.edit}">Modifier</a>  </li>` +
            `</ul>` +
            `</div>` +
        `</div>`

        self.modal.getElementsByClassName('cd-schedule-modal__event-info')[0].innerHTML = html;
